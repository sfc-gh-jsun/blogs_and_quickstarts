# Snowflake Openflow and Streams to AWS: Production-Ready Real-Time Fraud Alerting
...
Download this [Openflow connector definition file](https://snowflake-corp-se-workshop.s3.us-west-1.amazonaws.com/Openflow_fraud_detection_CDC/Openflow_Fraud_detection_streams.json) and save it to your desktop.
...
- **Intelligent Alert Filtering**: Multi-condition logic ensures only high-priority alerts reach customers
